...
public abstract class pnodePQ
{
   ...
   *                           <code>attrNull</code> encountered
   * @exception TupleUtilsException error in tuple compare routines
 * @throws iterator.sm_join_assign_src.TupleUtilsException 
   */
  public int pnodeCMP(pnode a, pnode b) 
         throws IOException, UnknowAttrType, TupleUtilsException, iterator.sm_join_assign_src.TupleUtilsException {
 ...
 * @throws iterator.sm_join_assign_src.TupleUtilsException 
   */  
  public boolean pnodeEQ(pnode a, pnode b) throws IOException, UnknowAttrType, TupleUtilsException, iterator.sm_join_assign_src.TupleUtilsException {
