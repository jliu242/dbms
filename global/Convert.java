 ...
 */
  ...
  /**
   * update an intervaltype value in the given byte array at the specified position
   * @param  	data 		a byte array
  ...
  public static void setIntervaltypeValue (intervaltype value, int position, byte []data) 
    throws java.io.IOException
    {
      ...
      DataOutputStream outstr2 = new DataOutputStream (out2);
      
      // write the value to the output stream
      
      outstr.writeInt(value.gets());
      outstr2.writeInt(value.gete());
